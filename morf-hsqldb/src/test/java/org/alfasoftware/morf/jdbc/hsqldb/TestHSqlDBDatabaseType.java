...
package org.alfasoftware.morf.jdbc.hsqldb;
...
/**
 * Tests for DatabaseType.HSQLDB
 *
 * @author Copyright (c) Alfa Financial Software 2014
 */
public class TestHSqlDBDatabaseType {
  ...
  public void testFormatJdbcUrl() {
    ...
    assertEquals("jdbc:hsqldb:mem:alfa" + suffix, databaseType.formatJdbcUrl(jdbcUrlElementBuilder().withDatabaseName("alfa").build()));
  ...
  public void getXADataSourceForHSQLDBShouldThrowException(){
  ...
  public void testIdentifyFromMetaData() throws SQLException {
    ...
    // -- Support platforms...
    //
    assertEquals(databaseType, new DatabaseTypeIdentifier(mockDataSourceFor("HSQLDB", "2.5.1", 2, 5)).identifyFromMetaData().get());
  }


  private Builder jdbcUrlElementBuilder() {
    return JdbcUrlElements.forDatabaseType(HSqlDB.IDENTIFIER);
  }
}
