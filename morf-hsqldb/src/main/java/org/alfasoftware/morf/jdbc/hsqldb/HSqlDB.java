...
/**
 * Support for HSQLDB database hosts.
 *
 * @author Copyright (c) Alfa Financial Software 2020
 */
public final class HSqlDB extends AbstractDatabaseType {
  ...
  //TODO commented out H2 additional parameters
  ...
  public Schema openSchema(Connection connection, String databaseName, String schemaName) {
    return new HSqlDBMetaDataProvider(connection);
  }
  ...
  public XADataSource getXADataSource(String jdbcUrl, String username, String password) {
    throw new UnsupportedOperationException("HSQLDB does not fully support XA connections. "
  ...
  public SqlDialect sqlDialect(String schemaName) {
    return new HSqlDBDialect(schemaName);
  }
  ...
  public boolean matchesProduct(String product) {
    return product.equalsIgnoreCase("HSQLDB");
  }
